...
let img1;
   ...
   let s = 'aaaA health IoT platform to enable medical team to track COVID-19 patients without being in direct contact with them. This could improve safety for medical staff. Furthermore, AI techniches may be used on IoT data collected to implement models that could be used, for example, on COVID19 risk assessment and decision making in high pressure environments (reference COVID19 hospitals).';
